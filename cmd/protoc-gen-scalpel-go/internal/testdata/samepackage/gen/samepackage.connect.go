...
type TestServiceClient interface {
	Method(context.Context, *scalpel.Request[Request]) (*scalpel.Response[Response], error)
}

// NewTestServiceClient constructs a client for the connect.test.same_package.TestService service.
// By default, it uses the gRPCConnect protocol with the binary Protobuf Codec, asks for gzipped
...
func NewTestServiceClient(httpClient scalpel.HTTPClient, baseURL string, opts ...scalpel.ClientOption) TestServiceClient {
	...
	return &testServiceClient{
		method: scalpel.NewClient[Request, Response](
			httpClient,
...
type testServiceClient struct {
	method *scalpel.Client[Request, Response]
}

// Method calls connect.test.same_package.TestService.Method.
func (c *testServiceClient) Method(ctx context.Context, req *scalpel.Request[Request]) (*scalpel.Response[Response], error) {
...
func (UnimplementedTestServiceHandler) Method(context.Context, *scalpel.Request[Request]) (*scalpel.Response[Response], error) {
	return nil, scalpel.NewError(scalpel.CodeUnimplemented, errors.New("connect.test.same_package.TestService.Method is not implemented"))
}

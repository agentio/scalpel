...
import (
	...
	gen "github.com/agentio/scalpel/cmd/protoc-gen-scalpel-go/internal/testdata/diffpackage/gen"
	http "net/http"
	strings "strings"
)
...
func (UnimplementedTestServiceHandler) Method(context.Context, *scalpel.Request[gen.Request]) (*scalpel.Response[gen.Response], error) {
	return nil, scalpel.NewError(scalpel.CodeUnimplemented, errors.New("connect.test.different_package.TestService.Method is not implemented"))
}

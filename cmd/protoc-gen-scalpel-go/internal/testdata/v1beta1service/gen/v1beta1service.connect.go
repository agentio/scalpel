...
type ExampleV1BetaClient interface {
	Method(context.Context, *scalpel.Request[GetExample_Request]) (*scalpel.Response[Get1ExampleResponse], error)
}
...
func NewExampleV1BetaClient(httpClient scalpel.HTTPClient, baseURL string, opts ...scalpel.ClientOption) ExampleV1BetaClient {
	baseURL = strings.TrimRight(baseURL, "/")
	exampleV1BetaMethods := File_v1beta1service_proto.Services().ByName("ExampleV1beta").Methods()
	return &exampleV1BetaClient{
		method: scalpel.NewClient[GetExample_Request, Get1ExampleResponse](
			httpClient,
			baseURL+ExampleV1BetaMethodProcedure,
			scalpel.WithSchema(exampleV1BetaMethods.ByName("Method")),
...
type exampleV1BetaClient struct {
	method *scalpel.Client[GetExample_Request, Get1ExampleResponse]
}

// Method calls example.ExampleV1beta.Method.
func (c *exampleV1BetaClient) Method(ctx context.Context, req *scalpel.Request[GetExample_Request]) (*scalpel.Response[Get1ExampleResponse], error) {
...
func (UnimplementedExampleV1BetaHandler) Method(context.Context, *scalpel.Request[GetExample_Request]) (*scalpel.Response[Get1ExampleResponse], error) {
	return nil, scalpel.NewError(scalpel.CodeUnimplemented, errors.New("example.ExampleV1beta.Method is not implemented"))
}

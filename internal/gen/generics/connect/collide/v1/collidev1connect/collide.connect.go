...
import (
	...
	v1 "github.com/agentio/scalpel/internal/gen/connect/collide/v1"
	http "net/http"
	strings "strings"
)
...
type CollideServiceClient interface {
	Import(context.Context, *scalpel.Request[v1.ImportRequest]) (*scalpel.Response[v1.ImportResponse], error)
}
...
func NewCollideServiceClient(httpClient scalpel.HTTPClient, baseURL string, opts ...scalpel.ClientOption) CollideServiceClient {
	...
	return &collideServiceClient{
		_import: scalpel.NewClient[v1.ImportRequest, v1.ImportResponse](
			httpClient,
			baseURL+CollideServiceImportProcedure,
			scalpel.WithSchema(collideServiceMethods.ByName("Import")),
...
type collideServiceClient struct {
	_import *scalpel.Client[v1.ImportRequest, v1.ImportResponse]
}

// Import calls connect.collide.v1.CollideService.Import.
func (c *collideServiceClient) Import(ctx context.Context, req *scalpel.Request[v1.ImportRequest]) (*scalpel.Response[v1.ImportResponse], error) {
...
func (UnimplementedCollideServiceHandler) Import(context.Context, *scalpel.Request[v1.ImportRequest]) (*scalpel.Response[v1.ImportResponse], error) {
	return nil, scalpel.NewError(scalpel.CodeUnimplemented, errors.New("connect.collide.v1.CollideService.Import is not implemented"))
}
